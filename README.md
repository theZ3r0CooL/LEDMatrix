...
- `uint32_t getPixelColor(uint16_t x, uint16_t y)`: Gets the color of the LED at position `(x, y)` in the matrix.
...
- `uint16_t getNumPixels()`: Returns the total number of pixels in the matrix.
